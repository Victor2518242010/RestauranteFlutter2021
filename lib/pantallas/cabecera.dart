...
class cabeceraPagina extends StatefulWidget {
  @override
  _cabeceraPaginaState createState() => _cabeceraPaginaState();
}

class _cabeceraPaginaState extends State<cabeceraPagina> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        placesWidget("Logo", "Ensalada Rusa"),
                        SizedBox(
                          height: 20,
                        ),
                        Row(
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                image:
                    DecorationImage(image: AssetImage("assets/img/$img.png"))),
          ),
          Column(
    ...
    return Row(
      children: [
        Container(
          ...
          width: 100,
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("$img.png"))),
        ),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
